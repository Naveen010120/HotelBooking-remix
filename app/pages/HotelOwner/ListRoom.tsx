...
export function ListRoom(){
    ...
    return(
        <div>
           ...
           <Title align="left" font="mono" title="Room Listing" subtitle=" Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis distinctio temporibus, fuga possimus quis adipisci?" />
                    ...
                    <tbody className="text-sm">
                        {
                            rooms.map((item,index)=>(
                                <tr key={index}>
                                    ...
                                    <td className="py-3 px-4 text-red-500 border-t border-gray-300 max-sm:hidden text-center">
