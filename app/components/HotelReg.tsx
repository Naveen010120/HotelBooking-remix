...
export function HotelRegistation(){
    return (
        <div className="fixed top-0 bottom-0 left-0 right-0 pt-10 z-100  flex items-center justify-center bg-black/70">
            <form className="flex bg-white rounded-xl max-w-4xl max-md:mx-2">
                ...
                <div className="relative flex flex-col items-center  md:w-1/2 p-8 md:p-10">
                    ...
                    <input type="text" placeholder="Type Here" className="border border-gray-200  rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" id="phone" required/>
                    </div>
                    <div className="w-full  mt-4">
