...
export  function HotelCard({room,index}:Props) {
  return (
    <Link to={'/roomsdetails/'+room._id} onClick={()=>scrollTo(0,0)} key={room._id} className="relative max-w-70 w-full  rounded-xl  overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)] max-w-64">
        ...
        <div className="p-4 pt-5">
            <div className="flex items-center justify-between">
                <p className="font-mono text-xl font-medium text-gray-800">{room.hotel.name}</p>
